...
Thank you for considering contributing to Circuitry. This document explains how to set up the repository locally, run the project, run tests, and the preferred workflow for making changes, opening pull requests and preparing releases.
...
- Use `@circuitry/shared` types and Zod schemas for shared shapes — do not re-declare common types.
...
- The manifest at [custom_components/circuitry/manifest.json](custom_components/circuitry/manifest.json) must be kept in sync with release versions.
...
Thank you for helping improve Circuitry! We appreciate careful, well-tested contributions.
