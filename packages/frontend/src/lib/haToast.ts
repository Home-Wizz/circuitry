 ...
 * dev mode leaves this `null` so `showToast` falls back to Circuitry's own
 ...
 * Circuitry is mounted as a real HA panel (bubbles/composed to cross the Shadow
 * DOM boundary into HA's own document), falls back to Circuitry's own
